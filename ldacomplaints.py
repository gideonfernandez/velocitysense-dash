...
# Now we can load and use spacy to analyse our complaintldacomplaints
...
def lda_analysis(df, stop_words):
    ...
    df = df[pd.notnull(df["9. What barriers to participation have been mentioned by participants? "])]
    docs = list(df["9. What barriers to participation have been mentioned by participants? "].values)
